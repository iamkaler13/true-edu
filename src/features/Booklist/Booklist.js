            ...
            {products.map((product, key) => (
              <div key={product.id} className="group relative pb-[55px] sm:pb-0">
                ...
                <div className="mt-[2px] sm:mt-4  justify-between">
                  ...
                  <button className="text-[#FF5721] float-right sm:float-left hover:text-heading my-3 sm:!mt-2 text-[16px] sm:text-[18px] sm:my-0 text-lg font-semibold dark:focus:ring-yellow-900 rounded-lg">
